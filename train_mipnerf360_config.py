#!/usr/bin/env python3
"""Batch training script for MipNeRF-360 scenes."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Batch training for MipNeRF-360")
    parser.add_argument("--data_path", type=str, required=True,
                       help="Base path to the MipNeRF-360 dataset")
    parser.add_argument("--output_path", type=str, default="output/quadgaussian_mipnerf360",
