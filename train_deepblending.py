#!/usr/bin/env python3
"""Batch training script for Deep Blending scenes."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Batch training for Deep Blending")
    parser.add_argument("--data_path", type=str, required=True,
                       help="Base path to the Deep Blending dataset")
    parser.add_argument("--output_path", type=str, default="output/quadgaussian_db",
